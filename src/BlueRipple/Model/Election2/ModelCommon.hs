...
data SurveyAggregation b where
  ...
  RoundedWeightedAggregation :: DP.WeightingStyle -> SurveyAggregation TE.EIntArray
  WeightedAggregation :: RealCountModel -> DP.WeightingStyle -> SurveyAggregation TE.ECVec
